...
public class NotificationController {
    ...
    public ResponseEntity<String> sendVerification(@RequestBody NotificationRequest request) {
    ...
    public ResponseEntity<String> sendOrderStatus(@RequestBody NotificationRequest request) {
